...
do
    echo "Running main.py with aligned_proportion = $prop"
    python main.py --aligned_proportion $prop --use_global_zero --sup
    echo "Completed run with aligned_proportion = $prop"
...
do
    echo "Running main.py with aligned_proportion = $prop"
    python  main.py --aligned_proportion $prop --sup
    echo "Completed run with aligned_proportion = $prop"
...
do
    echo "Running main.py with aligned_proportion = $prop"
    python main_baseline.py --aligned_proportion $prop --use_global_zero --sup
    echo "Completed run with aligned_proportion = $prop"
...
do
    echo "Running main.py with aligned_proportion = $prop"
    python  main_baseline.py --aligned_proportion $prop --sup
    echo "Completed run with aligned_proportion = $prop"
